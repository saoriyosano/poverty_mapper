...
def process_tfrecords_all(ex):
    ...
    - may include other keys if self.scalar_features is not None
    '''
    img_bands = ['RED', 'GREEN', 'BLUE','NIR', 'SWIR1', 'SWIR2']  # CHANGE THIS!!!!
